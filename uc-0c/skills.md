skills:
 - name: load_dataset 
   description: Load the budget CSV, validate required columns, and report null rows before any growth computation.
   input: A CSV file path and the expected column names: period, ward, category, budgeted_amount, actual_spend, and notes.
