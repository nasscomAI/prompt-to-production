...
skills:
  - name: retrieve_policy
    ...
    output: A list of dicts, each with keys — section_number (e.g. "2"), section_title (e.g. "ANNUAL LEAVE"), and clauses (a list of dicts with clause_number e.g. "2.3" and clause_text as the full verbatim text of that clause). Returns all sections and all clauses without truncation.
