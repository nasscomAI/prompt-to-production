...
skills:
  ...
  - name: answer_question
    description: Search indexed documents for the best single-source answer or refuse when the question is not covered.
    ...
    error_handling: If multiple documents provide conflicting answers, return the refusal template instead of blending.
