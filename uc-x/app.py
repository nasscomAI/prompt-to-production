...
def load_and_index_documents(docs_dir: str) -> list:
    """
    Reads all policy text files and indexes them by file name and line number.
    """
    index = []
...
def search_single_source(query: str, index: list) -> dict:
    """
    Finds the best matching source document and line without blending across files.
    """
