...
failure_modes:
  - "Taxonomy drift: Using category names that vary across rows for the same type of complaint."
  - "Severity blindness: Classifying injury, child, or school-related complaints as Standard instead of Urgent."
  - "Missing justification: Failing to provide a reason field or citing words not in the description."
  - "Hallucinated sub-categories: Using category names not in the allowed list."
  - "False confidence on ambiguity: Confidently classifying genuinely ambiguous complaints instead of flagging them."
