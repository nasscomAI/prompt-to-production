...
def parse_clauses(text: str) -> list:
    """
    Splits policy text into distinct sections and numbered clauses.
    """
    ...
    for line in lines:
        ...
        # Detect Clause, Section, Rule, or numbered headers (e.g., '1.', 'Clause 2:', 'Rule A:')
...
def extract_critical_constraints(text: str) -> list:
    """
    Identifies and preserves sentences containing quantitative limits, conditions, or penalties.
    """
...
def generate_summary(input_path: str, output_path: str):
    """
    Processes policy document and writes a strict clause-complete summary.
    """
...
def main():
    ...
    # Handle paths whether executed from root or inside uc-0b/
