...
def retrieve_policy(file_path: str):
    """
    Reads policy file and extracts numbered clauses.
    Returns list of tuples: (clause_number, clause_text)
    """
    clauses = []
...
def summarize_policy(clauses):
    """
    Produces summary preserving clause meaning.
    """
    summary_lines = []

    for number, text in clauses:
        # simple controlled summarization
        sentence = text.replace("\n", " ").strip()

        # If sentence too complex, quote it directly
