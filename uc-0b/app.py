...
def retrieve_policy(input_path: str) -> dict:
    """
    Loads policy text file; parses it and stores into structured numbered sections.
    """
    try:
...
def summarize_policy(clauses: dict) -> str:
    ...
    summary_lines = [
        "IRIS Employee Leave Policy - Critical Clauses Summary",
        "=====================================================",
        "All critical clauses have been extracted as is to prevent any obligation softening,",
