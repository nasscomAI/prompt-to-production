...
Run "Summarize the policy document." first. Then check: which of the 10 clauses above are missing? Which have had conditions dropped? Scope bleed to look for: phrases like "as is standard practice", "typically in government organisations", "employees are generally expected to" — none of these are in the source document.
